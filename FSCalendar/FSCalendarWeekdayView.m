...
- (void)layoutSubviews
{
    ...
    CGFloat contentWidth = self.contentView.fs_width - 18 * 2;
...
- (void)configureAppearance
{
    ...
    for (NSInteger i = 0; i < self.weekdayPointers.count; i++) {
        ...
        label.textColor = (i + self.calendar.firstWeekday) % 7 == 0 || (i + self.calendar.firstWeekday) % 7 == 1
        ? self.calendar.appearance.weekdayWeekendTextColor
